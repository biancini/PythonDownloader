...
public class HappinessFacetParserTest {
	...
	public void shouldParseProcessAllInput() throws IOException {
		...
		HappinessFacetParser happinessFacetCollector = new HappinessFacetParser(settings, null, null);
		...
		// when
		FacetExecutor facetExecutor = happinessFacetCollector.parse(FACET_NAME, parser, context);

		// then
		assertThat(happinessFacetCollector).isInstanceOf(HappinessFacetParser.class);
